...
bar and token family of its own, renders inside that frame when embedded and keeps its
standalone chrome only on `/monitoring`. Screenshots of every page live in
