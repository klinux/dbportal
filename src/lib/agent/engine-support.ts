 ...
 *
 * It lives here because the list this module publishes is what its callers print - today
 * the agent posture popover (`src/lib/agent/posture.ts`), and until the rebrand the login
 * hero as well - and each of them had written `join(" and ")`. That was
