  ...
  (
    ...
    const handleBeforeMount = (monacoInstance: typeof Monaco) => {
      ...
      monacoInstance.editor.defineTheme("db-dark", {
        ...
        inherit: true,
        rules: [
          // docs/DESIGN.md: SQL keywords in the dark signal blue; the rest as before.
          { token: "keyword", foreground: "4e96ff", fontStyle: "bold" },
          { token: "function", foreground: "dcdcaa" },
          { token: "string", foreground: "ce9178" },
          { token: "number", foreground: "b5cea8" },
          { token: "comment", foreground: "6a9955" },
          { token: "operator", foreground: "c9d1db" },
          { token: "identifier", foreground: "9cdcfe" },
        ],
        colors: {
          "editor.background": "#0b0e14",
          "editor.foreground": "#e8ecf1",
          "editorCursor.foreground": "#4e96ff",
          "editor.lineHighlightBackground": "#11151d",
          "editorLineNumber.foreground": "#3c4655",
          "editorLineNumber.activeForeground": "#9aa5b2",
          "editor.selectionBackground": "#1f3a6b",
          "editor.inactiveSelectionBackground": "#232a36",
          "editorIndentGuide.background": "#1a202a",
          "editorIndentGuide.activeBackground": "#232a36",
        },
      });
      ...
      monacoInstance.editor.defineTheme("db-light", {
        ...
        inherit: true,
        rules: [
          { token: "keyword", foreground: "1f6feb", fontStyle: "bold" },
          { token: "function", foreground: "795e26" },
          { token: "string", foreground: "a31515" },
          { token: "number", foreground: "098658" },
          { token: "comment", foreground: "008000" },
          { token: "operator", foreground: "4a5563" },
          { token: "identifier", foreground: "001080" },
        ],
        colors: {
          "editor.background": "#f4f6f8",
          "editor.foreground": "#0b0e14",
          "editorCursor.foreground": "#1f6feb",
          "editor.lineHighlightBackground": "#e9edf1",
          "editorLineNumber.foreground": "#98a3b0",
          "editorLineNumber.activeForeground": "#5c6672",
          "editor.selectionBackground": "#cfe0fd",
          "editor.inactiveSelectionBackground": "#e3eaf4",
          "editorIndentGuide.background": "#d7dde4",
          "editorIndentGuide.activeBackground": "#c3cbd4",
        },
      });
    };
